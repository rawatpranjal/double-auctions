for t in range(15):
    ...
    log.stepData.to_csv(f'data2/log_single_{len(disclosure)}_{depth}_{t}_last.csv')
    log.roundData.to_csv(f'data2/round_single_{len(disclosure)}_{depth}_{t}_last.csv')