for t in range(15):
    ...
    log.stepData.to_csv(f'data2/log_SINGLE_{len(disclosure)}_{depth}_{t}_DIFF.csv')
    log.roundData.to_csv(f'data2/round_SINGLE_{len(disclosure)}_{depth}_{t}_DIFF.csv')