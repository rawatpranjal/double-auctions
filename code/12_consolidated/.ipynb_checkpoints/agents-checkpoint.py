...
class Reinforcer(Trader):
    def __init__(self, gameData, disclosure=[], index=0, buyer=1, reinforcer=1, numStates = 1, 
                 numActions=10, algo='BASE', depth = 0, verbose = 0, algoArgs=[]):
        super().__init__(gameData, disclosure, index, buyer, reinforcer)
        self.depth = depth
        self.disclosure = disclosure
        ...
        self.algo = loadAlgo(algo, algoArgs=algoArgs)
        self.done = False
